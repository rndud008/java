...
public class TerminalOperationMain {
    public static void main(String[] args) {
        ...
        // Collectors 는 뒤에서 더 자세히 (복잡한 수집이 필요할때 사용
        ...
        System.out.println("9. findFirst - 첫번째요소");
        Integer first = numbers.stream().filter(n -> n > 5)
                .findFirst().get();
        System.out.println("5보다 큰 첫번째 숫자 :" + first);
        System.out.println();

        System.out.println("10. findAny - 아무 요소나 하나 찾기");
        Integer any = numbers.stream().filter(n -> n > 5)
                .findAny().get();
        System.out.println("5보다 큰 첫번째 숫자 :" + any);
        System.out.println();
        ...
        System.out.println("12. allMatch - 모든 요소가 조건을 만조하는지");
